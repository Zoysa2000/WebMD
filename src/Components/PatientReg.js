...
function PatientReg()
{
  ...
  Join our platform and unlock exciting career opportunities with top tech companies. Create your profile to showcase your skills, experience, and qualifications, and get matched with job openings that align with your expertise.</p>
  <div className="card text-center col-12 col-md-8 mx-auto" style={{ borderRadius: '8px' }}>
   ...
   <input
      ...
      <Button  type="submit" className="mt-3 w-100 mb-3" style={{backgroundColor:"red",borderColor:"red"}}>Register With Workreap</Button>
      </form>
    </div>
   </div>
</div>
